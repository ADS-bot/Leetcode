<h2><a href="https://leetcode.com/problems/sum-of-subsequence-widths">927. Sum of Subsequence Widths</a></h2><h3>Hard</h3><hr><p>The <strong>width</strong> of a sequence is the difference between the maximum and minimum elements in the sequence.</p>
